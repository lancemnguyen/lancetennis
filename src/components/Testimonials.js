...
const Testimonials = () => {
    ...
    const testimonials = [
        {
        text: "I can’t recommend Coach Lance highly enough as a tennis coach. He’s incredibly patient and always takes the time to break down even the most complex techniques into simple steps I can understand. For example, when I struggled with my backhand, he calmly worked with me, adjusting my grip and footwork until I felt confident.<br><br>" +

        "Coach Lance is also exceptionally knowledgeable about the game. Whether it’s the technical aspects of a serve or the mental strategies for match play, he always has valuable insights to share. During one lesson, he explained the biomechanics of my forehand in a way that immediately improved my swing and power.<br><br>" +

        "What truly sets him apart is how easygoing and approachable he is. No matter how many questions I ask or how many times I mess up a drill, he always responds with encouragement and a smile. Lessons with him are both productive and enjoyable, and I always leave feeling motivated and excited to improve.<br><br>" +
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-4 sm:gap-8">
                <p className="text-slate-600 italic max-w-[800px] w-full mx-auto font-light text-center">
                    {testimonials[showTestimonial].text.split('<br>').map((line, index) => (
                        <span key={index}>
                            {line}
                            <br />
                        </span>
